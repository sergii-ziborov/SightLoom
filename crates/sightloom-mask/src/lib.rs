...
//! Compact mask representations and morphology for `SightLoom`.
//!
//! `SightLoom` returns mask data for downstream compositors (for example a
//! host overlay engine). This crate does not draw, blur, or encode video pixels.
